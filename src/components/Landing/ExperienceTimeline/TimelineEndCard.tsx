...
const TimelineEndCard = () => {
  return (
    <div className="flex w-full mb-12">
      ...
      <div className="grow p-8 rounded-lg shadow-md border border-border bg-card transition-all duration-700 ease-out ml-4 flex items-center justify-center text-center">
